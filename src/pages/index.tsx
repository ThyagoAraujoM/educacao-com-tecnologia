...
const Home: NextPage = () => {
  function handleSubmit(values: formData) {
    ...
    writeUserData(uid, typeOfSuggestion, email, mensagem);
  }
  return (
      ...
      <ThemeProvider theme={defaultTheme}>
          ...
          <ul className={"c-grid2"}>
            ...
            <li>
              ...
              <p>
                ...
                atendida, faremos o possível para conseguir dar acesso a
                educação para o aluno.
              </p>
            </li>
          </ul>
        </Introduction>
        <Cadastro>
          <div className={"c-text-grid"}>
            ...
            <div>
              <p>
                Temos dois processos padrões para o cadasteo do aluno. O
                Primeiro sendo as escolas já cadatradas em nosso sistema, passam
                para nós os alunos que eles não conseguiram inserir dentro da
                escola, por motivos de não ter estrutura adequada para o acesso
                do aluno ou falta de vagas, entre outros motivos. A Segunda
                forma são as inscrições individuais, onde os pais passam a nos
                contatar e passando por todo um processo para podermos entender
                a sua situação.
              </p>
              <p>
                Para ambos os processos avaliamos a situação em que se encontra
                o aluno e caso precise, ajudamos com o acesso a internet e
        ...
        <Plataforma>
          <div className={"c-text-grid"}>
            ...
            <p>
              ...
              <strong> sistema de voz e leitura de tela</strong> para navegação
              e<strong> mudança de cores</strong> para visualização.
            </p>
            ...
            <p>
              ...
              do aluno, utilizando desafios individuais e em grupo com
              recompensas como icones de perfil personalizados entre outros, com
              isso os desafios em equipe criam uma turma mais proativa e
              desenvolve o trabalho em equipe. Ao lado temos um exemplo dos
              desafios individuais e abaixo os em grupos.
            </p>
          </div>
          <div className={"c-image-grid"}>
            <Image
        ...
        <Footer>
          ...
          <p>
            ...
            pessoas em funerabilidade social, economica, física entre outras,
            com esse pensamento acreditamos que sempre podemos melhorar e
            aceita-mos de braços abertos dúvidas e sugestões de melhorias e
            locais que podemos dar mais atenção em nossa plataforma e serviço.
            Para isso deixamos um formulário onde pode escolher entre sugestão
            ou dúvida e enviar para nós, responderemos o mais breve possível.
            Obrigado desde já 💖.
          </p>
